...
('CLIENT-001', '2026-03-15 10:00:00', 3, 2);
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-002', '2026-03-15 11:00:00', 2, 4), -- Lokanga (12km)
('CLIENT-003', '2026-03-15 11:00:00', 3, 2), -- Carton (15km)
('CLIENT-004', '2026-03-15 11:00:00', 3, 3); -- Radisson (18km)
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-005', '2026-03-15 13:00:00', 2, 3), -- Radisson
('CLIENT-006', '2026-03-15 13:00:00', 2, 4); -- Lokanga
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-007', '2026-03-15 14:30:00', 15, 5), -- 15 personnes → Novotel
('CLIENT-008', '2026-03-15 14:30:00', 10, 6); -- 10 personnes → Ibis
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-009', '2026-03-15 16:00:00', 5, 2),
('CLIENT-010', '2026-03-15 16:00:00', 4, 3),
('CLIENT-011', '2026-03-15 16:00:00', 3, 4);
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-012', '2026-03-15 17:00:00', 6, 6); -- Ibis (25km)
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-016', '2026-03-15 19:00:00', 2, 2),  -- Carton
('CLIENT-017', '2026-03-15 19:00:00', 2, 3),  -- Radisson
('CLIENT-018', '2026-03-15 19:00:00', 2, 4);  -- Lokanga
...
INSERT INTO Reservation (client_id, date_heure_arrivee, nbr_pers, hotel_id) VALUES
('CLIENT-019', '2026-03-15 20:00:00', 2, 7),  -- Zebra Palace (devrait être visité 3ème)
('CLIENT-020', '2026-03-15 20:00:00', 2, 8),  -- Alpha Star (devrait être visité 1er)
('CLIENT-021', '2026-03-15 20:00:00', 2, 9);  -- Mikado Resort (devrait être visité 2ème)

-- ============================================================================
-- 6. TOKEN DE TEST (valide 24h)
-- ============================================================================
INSERT INTO Token (token, date_heure_expiration) VALUES
('TEST-TOKEN-2026-03-15', '2026-03-11 23:59:59');
